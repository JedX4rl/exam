...
public class TaskController {
    ...
    public TaskController(MongoTemplate mongoTemplate) {
    ...
    public String processKafkaMessage(
        ...
        Document document = mongoTemplate.findOne(query, Document.class, "test_collection");

        if (document == null) {
            throw new RuntimeException("Document not found in MongoDB");
        }
